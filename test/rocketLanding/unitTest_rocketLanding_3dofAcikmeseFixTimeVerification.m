...
BodyMapRocket.AtmosphereModel.model = 'exp';
...
% BodyMapRocket.AerodynamicModel.dragMethod = 'subsonic-fit';
BodyMapRocket.AerodynamicModel.area = 1.0;1.0;

% Orientation Model
BodyMapRocket.OrientationModel.includeCentrifugal = 0;
BodyMapRocket.OrientationModel.includeCentripetal = 0;
% Thrust Model
...
BodyMapRocket.ThrustModel.Ae                    = 0.01      ; % Nozzle Exit Area [m2]
BodyMapRocket.ThrustModel.includeBackPressure   = 0        ;
BodyMapRocket.ThrustModel.includeThrustRateLimit= 0        ;
BodyMapRocket.ThrustModel.collocationMethod     = 'zoh'    ; % thrust profile assumed collocation strategy (zoh/floor,foh/linear,spline,else)
   
BodyMapRocket.DynamicModel.exactOde = 0;
% Retrieve Models
...
if solveSCVx
    ...
    switch BodyMapRocket.DynamicModel.controlVariable
        ...
        %     Scopt.algorithm.sequential.trustRegion.type     = 'soft';
            ...
            Scopt.algorithm.sequential.trustRegion.radius     = 1e1;
        ...
        %     Scopt.algorithm.virtualControl.phases(1).states       = 1:7; %
            ...
            Scopt.algorithm.virtualControl.phases(1).lambda       = 1.0e2;
...
grid on
legend([h3dinitial,h3dlanding,h3dtraject],{'Initial Condition','Landing Site','Trajectory'})
